...
public class ZMatchRequestsTest {
    ...
    public void matchRequestsTest() {
        ViewInteraction textInputEditText = onView(
                allOf(childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textInputEditText.perform(replaceText("user8"), closeSoftKeyboard());
        ...
        ViewInteraction materialButton4 = onView(
                allOf(withId(R.id.pickupItem_denyBtn), withText("Deny"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.matchRequest_recyclerView),
                                        0),
                                5),
                        isDisplayed()));
        ...
        ViewInteraction appCompatImageButton3 = onView(
                allOf(withId(R.id.matchRequest_backBtn), withContentDescription("Back Button"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
